...
import sys
sys.path.append('..')
from DKalmanFilter.KalmanFilter import KalmanFilter
from sort import *
...
class CentroidTracker():
	...
	def deregister(self, objectID):
		if objectID not in self.deregistered.keys():
			self.deregistered[objectID] = {'centre': []}

		# to deregister an object ID we delete the object ID from both of our respective dictionaries
		self.deregistered[objectID]['centre'] = self.objects[objectID]
	...
	def update(self, rects):
		...
		# return the set of trackable objects (alternative return objects - disappeared)
		return self.objects